...
export default function NewProduct() {
  ...
  async function uploadImages(fs: File[]) {
    if (!fs.length) return [];
    const pin = getPin();
  ...
  return (
    <div className="container py-6 max-w-3xl">
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="cotton,anarkali,summer"
          />
        </div>
      </div>
      ...
      <div className="mt-4">
        ...
        />
        <p className="text-xs text-gray-500 mt-1">
          You can select multiple images. They will upload when you click Save.
        </p>
      </div>
